...
<div class="space-y-8" x-data="adminPanel()">
        ...
        <div class="relative">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-indigo-200 text-sm mt-2">📅 <?php echo e(now()->format('d.m.Y H:i')); ?></p>
                </div>
                   ...
                   class="bg-gradient-to-br from-blue-50 to-blue-100 p-3 rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 transform hover:scale-105 border border-blue-200 group">
                    <div class="text-center">
                        ...
                        <div class="mt-2 pt-2 border-t border-blue-200">
                            <p class="text-base font-bold text-blue-600"><?php echo e($urunSayisi); ?></p>
                   ...
                   class="bg-gradient-to-br from-orange-50 to-orange-100 p-3 rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 transform hover:scale-105 border border-orange-200 group">
                    <div class="text-center">
                        ...
                        <div class="mt-2 pt-2 border-t border-orange-200">
                            <p class="text-base font-bold text-orange-600"><?php echo e($siparisler); ?></p>
                            <p class="text-xs text-gray-600">
                                <?php if($siparisler > 0): ?>
                                    <?php echo e($bugununSiparisleri); ?> bugün
                                <?php else: ?>
                                    sipariş yok
                                <?php endif; ?>
                            </p>
                   ...
                   class="bg-gradient-to-br from-green-50 to-green-100 p-3 rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 transform hover:scale-105 border border-green-200 group">
                    <div class="text-center">
                        ...
                        <div class="mt-2 pt-2 border-t border-green-200">
                            <p class="text-base font-bold text-green-600"><?php echo e($platformStats['aktif_magaza'] ?? 0); ?></p>
                   ...
                   class="bg-gradient-to-br from-purple-50 to-purple-100 p-3 rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 transform hover:scale-105 border border-purple-200 group">
                    <div class="text-center">
                        ...
                        <div class="mt-2 pt-2 border-t border-purple-200">
                            <p class="text-base font-bold text-purple-600"><?php echo e($bayiSayisi); ?></p>
                   ...
                   class="bg-gradient-to-br from-teal-50 to-teal-100 p-3 rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 transform hover:scale-105 border border-teal-200 group">
                    <div class="text-center">
                        ...
                        <div class="mt-2 pt-2 border-t border-teal-200">
                            <p class="text-base font-bold text-teal-600"><?php echo e($kategoriSayisi); ?></p>
                   ...
                   class="bg-gradient-to-br from-indigo-50 to-indigo-100 p-3 rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 transform hover:scale-105 border border-indigo-200 group">
                    <div class="text-center">
                        ...
                        <div class="mt-2 pt-2 border-t border-indigo-200">
                            <p class="text-base font-bold text-indigo-600"><?php echo e($platformStats['toplam_magaza'] ?? 0); ?></p>
                   ...
                   class="bg-gradient-to-br from-cyan-50 to-cyan-100 p-3 rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 transform hover:scale-105 border border-cyan-200 group">
                    <div class="text-center">
                        ...
                        <div class="mt-2 pt-2 border-t border-cyan-200">
                            <p class="text-base font-bold text-cyan-600">%<?php echo e($errorStats['basarili_senkron_orani'] ?? 95); ?></p>
                    ...
                    <div class="text-center">
                        ...
                        <div class="mt-2 pt-2 border-t border-pink-200">
                            <p class="text-base font-bold text-pink-600">
                                <?php if(($errorStats['basarili_senkron_orani'] ?? 95) >= 95): ?>
                                    🟢
                                <?php elseif(($errorStats['basarili_senkron_orani'] ?? 95) >= 80): ?>
                                    🟡
                                <?php else: ?>
                                    🔴
                                <?php endif; ?>
            ...
            <div class="bg-white p-6 rounded-xl shadow-lg border border-gray-100">
                ...
                <div class="mb-6">
                    <div class="flex justify-between items-center mb-2">
                        ...
                        <span class="text-sm text-gray-600"><?php echo e($urunSayisi); ?>/100</span>
                    </div>
                    <div class="bg-gray-200 rounded-full h-2">
                        <div class="bg-gradient-to-r from-blue-400 to-blue-600 h-2 rounded-full" style="width: <?php echo e(min(($urunSayisi/100)*100, 100)); ?>%"></div>
                    </div>
                    <p class="text-xs text-gray-500 mt-1">100 ürüne ulaşmak için <?php echo e(max(0, 100-$urunSayisi)); ?> ürün daha</p>
                </div>
                ...
                <div class="mb-6">
                    <div class="flex justify-between items-center mb-2">
                        ...
                        <span class="text-sm text-gray-600"><?php echo e($bugununSiparisleri); ?>/5</span>
                    </div>
                    <div class="bg-gray-200 rounded-full h-2">
                        <div class="bg-gradient-to-r from-orange-400 to-orange-600 h-2 rounded-full" style="width: <?php echo e(min(($bugununSiparisleri/5)*100, 100)); ?>%"></div>
                    </div>
                ...
                <div class="mb-6">
                    <div class="flex justify-between items-center mb-2">
                        ...
                        <span class="text-sm text-gray-600"><?php echo e($bugunSenkron); ?>/10</span>
                    </div>
                    <div class="bg-gray-200 rounded-full h-2">
                        <div class="bg-gradient-to-r from-green-400 to-green-600 h-2 rounded-full" style="width: <?php echo e(min(($bugunSenkron/10)*100, 100)); ?>%"></div>
                    </div>
                ...
                <div class="pt-4 border-t border-gray-200">
                    <div class="text-center">
                        ...
                        <div class="text-2xl mb-2">
                            <?php if($genelBasari >= 80): ?> 🏆
                            <?php elseif($genelBasari >= 60): ?> 🥉
                            <?php elseif($genelBasari >= 40): ?> 🎖️
                            <?php else: ?> 🎯
                            <?php endif; ?>
                        </div>
                        <h4 class="font-semibold text-gray-800">%<?php echo e(number_format($genelBasari, 0)); ?> Tamamlandı</h4>
                ...
                <div class="space-y-4">
                    <div class="flex items-center justify-between p-4 bg-gradient-to-r from-orange-50 to-orange-100 rounded-xl border border-orange-200">
                        ...
                        <div class="text-right">
                            <span class="text-orange-600 font-bold text-lg"><?php echo e($platformStats['trendyol'] ?? 0); ?></span>
                    ...
                    <div class="flex items-center justify-between p-4 bg-gradient-to-r from-blue-50 to-blue-100 rounded-xl border border-blue-200">
                        ...
                        <div class="text-right">
                            <span class="text-blue-600 font-bold text-lg"><?php echo e($platformStats['hepsiburada'] ?? 0); ?></span>
                            <p class="text-xs text-gray-500">ürün</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center justify-between p-4 bg-gradient-to-r from-green-50 to-green-100 rounded-xl border border-green-200">
                        ...
                        <div class="text-right">
                            <span class="text-green-600 font-bold text-lg"><?php echo e($platformStats['n11'] ?? 0); ?></span>
                            <p class="text-xs text-gray-500">ürün</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center justify-between p-4 bg-gradient-to-r from-purple-50 to-purple-100 rounded-xl border border-purple-200">
                        ...
                        <div class="text-right">
                            <span class="text-purple-600 font-bold text-lg"><?php echo e($platformStats['amazon'] ?? 0); ?></span>
                            <p class="text-xs text-gray-500">ürün</p>
                        </div>
                    </div>
                </div>
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-white p-6 rounded-2xl shadow-lg border border-gray-100">
                <div class="flex items-center justify-between mb-6">
                    ...
                    <div class="flex space-x-2">
                        <span class="bg-green-100 text-green-800 text-xs px-3 py-1 rounded-full font-medium">
                            ✅ %<?php echo e($errorStats['basarili_senkron_orani'] ?? 95); ?> Başarı
                        </span>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <div class="text-center p-4 bg-gradient-to-br from-red-50 to-red-100 rounded-xl border border-red-200">
                        ...
                        <p class="text-lg font-bold text-red-600"><?php echo e($errorStats['cloudflare_engel'] ?? 0); ?></p>
                    ...
                    <div class="text-center p-4 bg-gradient-to-br from-yellow-50 to-yellow-100 rounded-xl border border-yellow-200">
                        ...
                        <p class="text-lg font-bold text-yellow-600"><?php echo e($errorStats['rate_limit_hata'] ?? 0); ?></p>
                    ...
                    <div class="text-center p-4 bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl border border-blue-200">
                        ...
                        <p class="text-lg font-bold text-blue-600"><?php echo e($platformStats['son_24_saat_senkron'] ?? 0); ?></p>
            ...
            <div class="bg-white p-6 rounded-2xl shadow-lg border border-gray-100">
                ...
                <div class="space-y-3 max-h-64 overflow-y-auto">
                    <?php $__currentLoopData = $sonAktiviteler; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $aktivite): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="flex items-center justify-between p-4 border border-gray-100 rounded-xl hover:bg-gray-50 transition-colors">
                        <div class="flex items-center">
                            <div class="w-3 h-3 mr-4 rounded-full
                                <?php if($aktivite['durum'] === 'success'): ?> bg-green-500 
                                <?php elseif($aktivite['durum'] === 'error'): ?> bg-red-500 
                                <?php else: ?> bg-yellow-500 <?php endif; ?> animate-pulse">
                            </div>
                            <div>
                                <p class="font-semibold text-gray-900 text-sm"><?php echo e($aktivite['islem']); ?></p>
                                <p class="text-gray-600 text-xs"><?php echo e($aktivite['magaza']); ?></p>
                            </div>
                        </div>
                        <div class="text-right">
                            <p class="text-xs text-gray-500"><?php echo e(\Carbon\Carbon::parse($aktivite['zaman'])->diffForHumans()); ?></p>
                            <div class="flex items-center mt-1">
                                <?php if($aktivite['durum'] === 'success'): ?>
                                    <span class="bg-green-100 text-green-800 text-xs px-2 py-1 rounded-full">✅ Başarılı</span>
                                <?php elseif($aktivite['durum'] === 'error'): ?>
                ...
                <?php $__empty_1 = true; $__currentLoopData = $sonSiparisler; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="bg-gradient-to-r from-gray-50 to-gray-100 p-4 rounded-xl border border-gray-200 hover:shadow-md transition-all">
                        <div class="flex justify-between items-center">
                            <div>
                                <p class="font-semibold text-sm text-gray-900"><?php echo e($s->siparis_no ?? ('SIP'.str_pad($s->id,6,'0',STR_PAD_LEFT))); ?></p>
                                <p class="text-xs text-gray-600"><?php echo e($s->kullanici->ad ?? '-'); ?></p>
                                <p class="text-xs text-gray-500"><?php echo e(optional($s->created_at)->diffForHumans()); ?></p>
                            </div>
                            <div class="text-right">
                                <div class="text-sm font-bold text-teal-600">
                                    <?php echo e(number_format((float)$s->toplam_tutar, 2)); ?> ₺
                                </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
        <div class="bg-white rounded-xl shadow border p-6">
            ...
            <?php if(count($yapilanlarOzet)): ?>
                <ul class="space-y-2 list-disc ml-5">
                    <?php $__currentLoopData = $yapilanlarOzet; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li class="text-sm text-gray-700"><?php echo e($i['ad']); ?></li>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </ul>
            <?php else: ?>
        ...
        <div class="bg-white rounded-xl shadow border p-6">
            ...
            <?php if(count($yapilacaklarOzet)): ?>
                <ul class="space-y-2 list-disc ml-5">
                    <?php $__currentLoopData = $yapilacaklarOzet; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li class="text-sm text-gray-700"><?php echo e($i['ad']); ?></li>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </ul>
            <?php else: ?>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\ai-b2b\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>