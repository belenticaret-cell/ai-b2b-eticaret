...
use App\Http\Controllers\Admin\VitrinYonetimiController;
...
// B2B Panel - Yeni Yapı
Route::prefix('b2b')->middleware(['auth', 'bayi'])->group(function () {
    Route::get('/dashboard', [App\Http\Controllers\B2B\BayiPanelController::class, 'dashboard'])->name('b2b.dashboard');
    Route::get('/urunler', [App\Http\Controllers\B2B\BayiPanelController::class, 'urunler'])->name('b2b.urunler');
    Route::get('/siparisler', [App\Http\Controllers\B2B\BayiPanelController::class, 'siparisler'])->name('b2b.siparisler');
    Route::get('/siparis/{id}', [App\Http\Controllers\B2B\BayiPanelController::class, 'siparisDetay'])->name('b2b.siparis-detay');
    Route::get('/toplu-siparis', [App\Http\Controllers\B2B\BayiPanelController::class, 'topluSiparis'])->name('b2b.toplu-siparis');
    Route::get('/cari-hesap', [App\Http\Controllers\B2B\BayiPanelController::class, 'cariHesap'])->name('b2b.cari-hesap');
    Route::get('/profil', [App\Http\Controllers\B2B\BayiPanelController::class, 'profil'])->name('b2b.profil');
    Route::post('/profil', [App\Http\Controllers\B2B\BayiPanelController::class, 'profilGuncelle'])->name('b2b.profil.guncelle');
});
...
// Vitrin Yönetimi
Route::get('/admin/vitrin', [VitrinYonetimiController::class, 'index'])->name('admin.vitrin.index');
Route::post('/admin/vitrin', [VitrinYonetimiController::class, 'update'])->name('admin.vitrin.update');
...
Route::prefix('admin')->group(function () {
    ...
    Route::delete('/gelistirici/not-sil/{id}', [GelistiriciController::class, 'notSil'])->name('admin.gelistirici.not-sil');
});
